...
fn month_name<'a>(
    ...
    let start_of_month = |m: u32| today().with_month(m).unwrap().with_day(1).unwrap();
    choice([
        regex("(?i)january").to(start_of_month(1)),
        regex("(?i)jan").to(start_of_month(1)),
        regex("(?i)february").to(start_of_month(2)),
        regex("(?i)feb").to(start_of_month(2)),
        regex("(?i)march").to(start_of_month(3)),
        regex("(?i)mar").to(start_of_month(3)),
        regex("(?i)april").to(start_of_month(4)),
        regex("(?i)apr").to(start_of_month(4)),
        regex("(?i)may").to(start_of_month(5)),
        regex("(?i)june").to(start_of_month(6)),
        regex("(?i)jun").to(start_of_month(6)),
        regex("(?i)july").to(start_of_month(7)),
        regex("(?i)jul").to(start_of_month(7)),
        regex("(?i)august").to(start_of_month(8)),
        regex("(?i)aug").to(start_of_month(8)),
        regex("(?i)september").to(start_of_month(9)),
        regex("(?i)sep").to(start_of_month(9)),
        regex("(?i)october").to(start_of_month(10)),
        regex("(?i)oct").to(start_of_month(10)),
        regex("(?i)november").to(start_of_month(11)),
        regex("(?i)nov").to(start_of_month(11)),
        regex("(?i)december").to(start_of_month(12)),
        regex("(?i)dec").to(start_of_month(12)),
    ])
}
