...
fn day_of_week<'a>() -> impl Parser<'a, &'a str, Interval, extra::Full<Rich<'a, char>, State, ()>> {
    let monday = regex("(?i)monday")
        .ignored()
        .or(regex("(?i)mon").ignored())
        .or(just("1st")
    ...
    let tuesday = regex("(?i)tuesday")
        .ignored()
        .or(regex("(?i)tue").ignored())
        .or(just("2nd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
    ...
    let wednesday = regex("(?i)wednesday")
        .ignored()
        .or(regex("(?i)wed").ignored())
        .or(just("3rd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
    ...
    let thursday = regex("(?i)thursday")
        .ignored()
        .or(regex("(?i)thu").ignored())
        .or(just("3rd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
    ...
    let friday = regex("(?i)friday")
        .ignored()
        .or(regex("(?i)fri").ignored())
        .or(just("3rd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
    ...
    let saturday = regex("(?i)saturday")
        .ignored()
        .or(regex("(?i)sat").ignored())
        .or(just("3rd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
    ...
    let sunday = regex("(?i)sunday")
        .ignored()
        .or(regex("(?i)sun").ignored())
        .or(just("3rd")
            .then(whitespace().repeated().at_least(1))
            .then(regex("(?i)day"))
            .then(whitespace().repeated().at_least(1))
